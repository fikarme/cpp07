...
class	Array {
	public:
		...
		Array< T >( unsigned int n )    // Constructor. It is unsigned int because it is the size of the array and size can't be negative value.
		{
			this->_size = n;
			this->_arr = new T[n];
            // We must use new operator to create an array as pdf dictates.
            // Because preventive allocation is forbidden.
            // Preventive allocation is allocating memory for an array before we know how many elements we need.
